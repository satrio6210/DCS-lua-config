...
local tankerStennis=RECOVERYTANKER:New("Stennis", "Texaco Group")

-- Custom settings:
tankerStennis:SetRadio(273)
tankerStennis:SetTACAN(45, "SHL")
...
rescueheloStennis=RESCUEHELO:New("CVN-71 Theodore Roosevelt", "Rescue Helo")
